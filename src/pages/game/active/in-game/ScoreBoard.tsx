export default function ScoreBoard(props: {AScore: number; BScore: number}) {
  ...
  return (
    <div className='absolute top-1/2 left-1/2 w-full transform -translate-x-1/2 -translate-y-1/2 z-20 flex flex-col items-center bg-opacity-0 p-0 rounded-md shadow-lg'>
